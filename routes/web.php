...
Route::middleware(AuthCheck::class)->group(function () {
    ...
    Route::get('/admin/logout', [AdminController::class, 'logout'])->name('AdminLogout');
     ...
     //slider
     Route::get('/admin/slider', [AdminController::class, 'list_slider'])->name('list_slider');
     Route::get('/admin/slider/add', [AdminController::class, 'add_slider'])->name('add_slider');
     Route::post('/admin/slider/add', [AdminController::class, 'slider_added'])->name('slider_added');

     Route::get('/admin/slider/{id}/del', [AdminController::class, 'del_slider'])->name('del_slider');
     Route::get('/admin/slider/{id}/edit', [AdminController::class, 'edit_slider'])->name('edit_slider');
     Route::post('/admin/slider/{id}/edit', [AdminController::class, 'slider_edited'])->name('slider_edited');
     //End Slider
...
Route::post('/notify-admin', 'NotificationController@notifyAdmin')->name('notify.admin');
