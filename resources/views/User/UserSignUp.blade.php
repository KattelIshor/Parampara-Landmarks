@push('title')
    Sign Up To Parampara-Landmarks
@endpush
...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome to<br />Parampara-Landmarks</h1>
            <p class="col-lg-10 fs-4">
                So, as you embark on this exciting journey, we invite you to embrace the magic and the endless possibilities that await you. Take your time, explore, and let your imagination run wild. Your dream property may be just a click away.
        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="POST" action="{{ route('UserSignup') }}">
                ...
                <x-log-input type="phone" name="phone" label="Phone Number" placeholder="98********" />
