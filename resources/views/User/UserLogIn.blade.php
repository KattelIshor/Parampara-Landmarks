...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome back to Parampara-Landmarks</h1>
            <p class="col-lg-10 fs-4">
                Remember, in every step of your real estate journey, you are not alone. We stand by your side, offering guidance, support, and expertise. Together, let us unlock the doors to new beginnings and endless opportunities.
            </p>
        </div>
